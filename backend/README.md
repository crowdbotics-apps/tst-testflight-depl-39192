...
## Project Structure
    ...
    ├── tst_testflight_depl_39192  # Django project configurations
...
1. Clone this repo and `cd tst_testflight_depl_39192`
...
2. Clone this repo and `cd tst_testflight_depl_39192`
