"""
Django settings for tst_testflight_depl_39192 project.
...
ROOT_URLCONF = 'tst_testflight_depl_39192.urls'
...
WSGI_APPLICATION = 'tst_testflight_depl_39192.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_testflight_depl_39192 API",
    "DESCRIPTION": "API documentation for tst_testflight_depl_39192 App",
    "VERSION": "v1",
}
